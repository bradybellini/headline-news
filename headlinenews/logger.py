...
fh = logging.handlers.RotatingFileHandler(
    filename="/home/brady/headline-news/logs/warning/headlinenews.log",
    maxBytes=10000000,
    backupCount=3,
    encoding="utf-8",
)
...
nfo = logging.handlers.RotatingFileHandler(
    filename="/home/brady/headline-news/logs/info/headlinenews_info.log",
    maxBytes=10000000,
    backupCount=3,
    encoding="utf-8",
)
...
dbug = logging.handlers.RotatingFileHandler(
    filename="/home/brady/headline-news/logs/debug/headlinenews_debug.log",
    maxBytes=50000000,
    backupCount=12,
    encoding="utf-8",
)
